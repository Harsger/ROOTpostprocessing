...
//            cout << " comment line " << r << endl ;
    ...
    TGraphErrors * g_integral = new TGraphErrors() ;
    g_integral->SetName("integral") ;
    g_integral->SetTitle("integral") ;
...
//                 cout << " toAdd " << toAdd << endl ;
        ...
        if( drawFits ){
            ...
            TPaveStats * box = (TPaveStats*)hists[h]->FindObject("stats") ;
